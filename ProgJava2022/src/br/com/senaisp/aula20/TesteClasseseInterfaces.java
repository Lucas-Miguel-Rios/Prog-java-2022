...
public class TesteClasseseInterfaces {
	...
	public static void main(String[] args) {
		...
		listaMamiferos.add(new Humano("Branca",45));
		
		listaVeiculos.add(new SuperMaquina("Chevrolet", "Onix", 2022, "16V"));
		listaVeiculos.add(new SuperMaquina("Toyota", "Ethios", 2022, "16V"));
		listaVeiculos.add(new SuperMaquina("Honda", "Titan", 2022, "8V"));
