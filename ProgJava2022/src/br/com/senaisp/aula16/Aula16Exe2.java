...
public class Aula16Exe2 {
	...
	private static void listagemCliente(Clientes[] cliVetor, Scanner sc) {
		...
		for (int intI=0; intI<LIMITE_CLIENTE; intI++) {
			if (cliVetor[intI]!=null) {
				//Mostrar com 3 posições de string
				//O que falta para 3 ele preenche com branco
	...
	/**
	 * Função que retorna o índice disponível para ser cadastrado o cliente. 
	 * Se não Houver disponível retornara -1.
	 * @param cliVetor Informar o vetor de clientes
	 * @return Retorna o índice disponível ou -1 se não houver mais espaço para
	 * cadastramento.
	 */
	...
	private static void efetuarCadastro(Clientes clientes, Scanner sc) {
		do {
			...
			try {
				...
				System.out.println("Ocorreu uma entrada inválida");
				sc.nextLine();
			}
		}while(true);
		//Entrada do nome
